...
1. Realiza el ejercicio en la carpeta correspondiente.
2. Genera los outputs esperados y súbelos a tu rama personal.
3. Solicita revisión con un Pull Request.
